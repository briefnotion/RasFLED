...
void AUTOMOBILE_GADGET::create()
{
  ...
  RPM_GUAGE.PROP.MAX_VALUE = 6000;
  RPM_GUAGE.PROP.MIN_VALUE = 0;
  RPM_GUAGE.PROP.MIN_MAX = false;
  ...
  BRAKE_PRESSURE_GUAGE.PROP.LABEL = "";
  BRAKE_PRESSURE_GUAGE.PROP.INDICATOR_CHARACTER = '0';
  BRAKE_PRESSURE_GUAGE.PROP.LABEL_SIZE = 0;
  BRAKE_PRESSURE_GUAGE.PROP.COLOR = COLOR_WHITE;
  BRAKE_PRESSURE_GUAGE.PROP.BCOLOR = COLOR_BLACK;
  BRAKE_PRESSURE_GUAGE.PROP.COLOR_BAR_BACK = COLOR_RED;
  BRAKE_PRESSURE_GUAGE.PROP.COLOR_MARKER = COLOR_BLUE;
  BRAKE_PRESSURE_GUAGE.PROP.BCOLOR_MARKER = COLOR_WHITE;
  BRAKE_PRESSURE_GUAGE.PROP.COLOR_MARKER_LIMIT = COLOR_BLUE;
  BRAKE_PRESSURE_GUAGE.PROP.POSY = 11;
  BRAKE_PRESSURE_GUAGE.PROP.POSX = 30;
  BRAKE_PRESSURE_GUAGE.PROP.BAR_SIZE = 20;
  BRAKE_PRESSURE_GUAGE.PROP.GUAGE_BAR = true;
  BRAKE_PRESSURE_GUAGE.PROP.MAX_VALUE = 100;
  BRAKE_PRESSURE_GUAGE.PROP.MIN_VALUE = 0;
  BRAKE_PRESSURE_GUAGE.PROP.MIN_MAX = false;
  BRAKE_PRESSURE_GUAGE.PROP.MIN_MAX_FILLER = true;
  BRAKE_PRESSURE_GUAGE.PROP.MIN_MAX_FILLER_BCOLOR = COLOR_BLUE;
  BRAKE_PRESSURE_GUAGE.PROP.MIN_MAX_FILLER_COLOR = COLOR_WHITE;
  BRAKE_PRESSURE_GUAGE.PROP.MIN_MAX_INDICATORS = false;
  BRAKE_PRESSURE_GUAGE.MIN_MAX_HISTORY.PROP.SLICES = 20;
  BRAKE_PRESSURE_GUAGE.MIN_MAX_HISTORY.PROP.TIME_SPAN = 60000;
  BRAKE_PRESSURE_GUAGE.PROP.COLORS_ON = true;

  // BRAKE PRESSURE Text
  BRAKE_PRESSURE.PROP.POSX = 30;
  BRAKE_PRESSURE.PROP.POSY = 12;
  BRAKE_PRESSURE.PROP.SIZEX = 20;
  BRAKE_PRESSURE.PROP.COLORS_ON = true;
  BRAKE_PRESSURE.PROP.BCOLOR = COLOR_BLACK;
  BRAKE_PRESSURE.PROP.COLOR = COLOR_WHITE;
  BRAKE_PRESSURE.PROP.JUSTIFICATION_LEFT = true;
...
void AUTOMOBILE_GADGET::update(system_data &sdSysData, unsigned long &tmeCurrentMillis)
{
  ...
  AD_360.set_text(sdSysData.CAR_INFO.DATA.AD_360.ORIG);
  ...
  SPEEDOMETER.update(sdSysData.CAR_INFO.STATUS.SPEED.mph_x_10() / 10, tmeCurrentMillis);
  ...
  BRAKE_PRESSURE_GUAGE.update(sdSysData.CAR_INFO.STATUS.BRAKE_PRESSURE.val_pressure(), tmeCurrentMillis);
  BRAKE_PRESSURE.set_text(sdSysData.CAR_INFO.STATUS.BRAKE_PRESSURE.pressure());
...
bool AUTOMOBILE_GADGET::draw(bool Refresh, unsigned long tmeFrame_Time)
{
  ...
  BRAKE_PRESSURE_GUAGE.draw(AUTOMOBILE_PANEL, Refresh);
  BRAKE_PRESSURE.draw(AUTOMOBILE_PANEL, Refresh);
