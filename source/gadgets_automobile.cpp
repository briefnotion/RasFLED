...
void AUTOMOBILE_GADGET::create()
{
  ...
  LARGE_SPEED_10.set_color(COLOR_BLACK, COLOR_WHITE);
  ...
  LARGE_SPEED_1.set_color(COLOR_BLACK, COLOR_WHITE);
  ...
  LARGE_GEAR_1.set_color(COLOR_BLACK, COLOR_WHITE);
