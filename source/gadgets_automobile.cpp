...
void AUTOMOBILE_OVERVIEW_GADGET::create()
{
  ...
  LF_UNFILTERED_TTL.PROP.COLOR = COLOR_WHITE;
  ...
  RF_UNFILTERED_TTL.PROP.COLOR = COLOR_WHITE;
  ...
  LB_UNFILTERED_TTL.PROP.COLOR = COLOR_WHITE;
  ...
  RB_UNFILTERED_TTL.PROP.COLOR = COLOR_WHITE;
...
void AUTOMOBILE_OVERVIEW_GADGET::update(system_data &sdSysData, unsigned long &tmeCurrentMillis)
{
  ...
  LF_UNFILTERED_TTL.set_color(  color_range(sdSysData.CAR_INFO.CALCULATED.UNFILTHERED_LF_TTL.val_life_percentage(), 0, 10, 75, 100, 200 ), COLOR_WHITE);
  RF_UNFILTERED_TTL.set_text(" " + sdSysData.CAR_INFO.CALCULATED.UNFILTHERED_RF_TTL.life_percentage());
  RF_UNFILTERED_TTL.set_color(  color_range(sdSysData.CAR_INFO.CALCULATED.UNFILTHERED_RF_TTL.val_life_percentage(), 0, 10, 75, 100, 200 ), COLOR_WHITE);
  LB_UNFILTERED_TTL.set_text(" " + sdSysData.CAR_INFO.CALCULATED.UNFILTHERED_LB_TTL.life_percentage());
  LB_UNFILTERED_TTL.set_color(  color_range(sdSysData.CAR_INFO.CALCULATED.UNFILTHERED_LB_TTL.val_life_percentage(), 0, 10, 75, 100, 200 ), COLOR_WHITE);
  RB_UNFILTERED_TTL.set_text(" " + sdSysData.CAR_INFO.CALCULATED.UNFILTHERED_RB_TTL.life_percentage());
  RB_UNFILTERED_TTL.set_color(  color_range(sdSysData.CAR_INFO.CALCULATED.UNFILTHERED_RB_TTL.val_life_percentage(), 0, 10, 75, 100, 200 ), COLOR_WHITE);
  ...
  LF_TTL.set_color(  color_range(sdSysData.CAR_INFO.CALCULATED.LF_TTL.val_life_percentage(), 0, 10, 75, 100, 200 ), COLOR_WHITE);
  RF_TTL.set_text(" " + sdSysData.CAR_INFO.CALCULATED.RF_TTL.life_percentage());
  RF_TTL.set_color(  color_range(sdSysData.CAR_INFO.CALCULATED.RF_TTL.val_life_percentage(), 0, 10, 75, 100, 200 ), COLOR_WHITE);
  LB_TTL.set_text(" " + sdSysData.CAR_INFO.CALCULATED.LB_TTL.life_percentage());
  LB_TTL.set_color(  color_range(sdSysData.CAR_INFO.CALCULATED.LB_TTL.val_life_percentage(), 0, 10, 75, 100, 200 ), COLOR_WHITE);
  RB_TTL.set_text(" " + sdSysData.CAR_INFO.CALCULATED.RB_TTL.life_percentage());
  RB_TTL.set_color(  color_range(sdSysData.CAR_INFO.CALCULATED.RB_TTL.val_life_percentage(), 0, 10, 75, 100, 200 ), COLOR_WHITE);
