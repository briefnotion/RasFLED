...
void AUTOMOBILE_GADGET::create()
{
  ...
  SPEEDO_WATERF_4M.PROP.POSX = 13 + 0;
  SPEEDO_WATERF_4M.PROP.POSY = 6;
  SPEEDO_WATERF_4M.PROP.BAR_SIZE = 19;
  SPEEDO_WATERF_4M.PROP.MIN_VALUE = 0;
  SPEEDO_WATERF_4M.PROP.MAX_VALUE = 255;
  SPEEDO_WATERF_4M.PROP.TIME_SPAN = 60000 * 4;
  SPEEDO_WATERF_4M.PROP.INDICATOR_CHARACTER = '0';
  SPEEDO_WATERF_4M.PROP.BRACKET_END_CAPS = false;
  SPEEDO_WATERF_4M.PROP.JECT = true;
  SPEEDO_WATERF_4M.PROP.COLOR_MARKER = COLOR_BLUE;
  SPEEDO_WATERF_4M.PROP.BCOLOR_MARKER = COLOR_WHITE;
  SPEEDO_WATERF_4M.PROP.COLOR_BAR_BACK = COLOR_BLUE;
  SPEEDO_WATERF_4M.PROP.COLOR_MARKER_LIMIT = COLOR_YELLOW;
  SPEEDO_WATERF_4M.create();

  SPEEDO_WATERF_16M.PROP.POSX = 13 + 0;
  SPEEDO_WATERF_16M.PROP.POSY = 7;
  SPEEDO_WATERF_16M.PROP.BAR_SIZE = 19;
  SPEEDO_WATERF_16M.PROP.MIN_VALUE = 0;
  SPEEDO_WATERF_16M.PROP.MAX_VALUE = 255;
  SPEEDO_WATERF_16M.PROP.TIME_SPAN = 60000 * 16;
  SPEEDO_WATERF_16M.PROP.INDICATOR_CHARACTER = '0';
  SPEEDO_WATERF_16M.PROP.BRACKET_END_CAPS = false;
  SPEEDO_WATERF_16M.PROP.JECT = true;
  SPEEDO_WATERF_16M.PROP.COLOR_MARKER = COLOR_BLUE;
  SPEEDO_WATERF_16M.PROP.BCOLOR_MARKER = COLOR_WHITE;
  SPEEDO_WATERF_16M.PROP.COLOR_BAR_BACK = COLOR_BLUE;
  SPEEDO_WATERF_16M.PROP.COLOR_MARKER_LIMIT = COLOR_YELLOW;
  SPEEDO_WATERF_16M.create();

  SPEEDO_WATERF_64M.PROP.POSX = 13 + 0;
  SPEEDO_WATERF_64M.PROP.POSY = 8;
  SPEEDO_WATERF_64M.PROP.BAR_SIZE = 19;
  SPEEDO_WATERF_64M.PROP.MIN_VALUE = 0;
  SPEEDO_WATERF_64M.PROP.MAX_VALUE = 255;
  SPEEDO_WATERF_64M.PROP.TIME_SPAN = 60000 * 64;
  SPEEDO_WATERF_64M.PROP.INDICATOR_CHARACTER = '0';
  SPEEDO_WATERF_64M.PROP.BRACKET_END_CAPS = false;
  SPEEDO_WATERF_64M.PROP.JECT = true;
  SPEEDO_WATERF_64M.PROP.COLOR_MARKER = COLOR_BLUE;
  SPEEDO_WATERF_64M.PROP.BCOLOR_MARKER = COLOR_WHITE;
  SPEEDO_WATERF_64M.PROP.COLOR_BAR_BACK = COLOR_BLUE;
  SPEEDO_WATERF_64M.PROP.COLOR_MARKER_LIMIT = COLOR_YELLOW;
  SPEEDO_WATERF_64M.create();

  SPEEDO_WATERF_256M.PROP.POSX = 13 + 0;
  SPEEDO_WATERF_256M.PROP.POSY = 9;
  SPEEDO_WATERF_256M.PROP.BAR_SIZE = 19;
  SPEEDO_WATERF_256M.PROP.MIN_VALUE = 0;
  SPEEDO_WATERF_256M.PROP.MAX_VALUE = 255;
  SPEEDO_WATERF_256M.PROP.TIME_SPAN = 60000 * 256;
  SPEEDO_WATERF_256M.PROP.INDICATOR_CHARACTER = '0';
  SPEEDO_WATERF_256M.PROP.BRACKET_END_CAPS = false;
  SPEEDO_WATERF_256M.PROP.JECT = true;
  SPEEDO_WATERF_256M.PROP.COLOR_MARKER = COLOR_BLUE;
  SPEEDO_WATERF_256M.PROP.BCOLOR_MARKER = COLOR_WHITE;
  SPEEDO_WATERF_256M.PROP.COLOR_BAR_BACK = COLOR_BLUE;
  SPEEDO_WATERF_256M.PROP.COLOR_MARKER_LIMIT = COLOR_YELLOW;
  SPEEDO_WATERF_256M.create();
...
{  
  ...
  if (SPEEDO_WATERF_64M.jecto_ready() == true)
  {
    SPEEDO_WATERF_256M.jecti(SPEEDO.jecto(), tmeFrame_Time);
  }

  if (SPEEDO_WATERF_16M.jecto_ready() == true)
  {
    SPEEDO_WATERF_64M.jecti(SPEEDO.jecto(), tmeFrame_Time);
  }

  if (SPEEDO_WATERF_4M.jecto_ready() == true)
  {
    SPEEDO_WATERF_16M.jecti(SPEEDO.jecto(), tmeFrame_Time);
  }

  if (SPEEDO.jecto_ready() == true)
  {
    SPEEDO_WATERF_4M.jecti(SPEEDO.jecto(), tmeFrame_Time);
  }
...
bool AUTOMOBILE_GADGET::draw(bool Refresh, unsigned long tmeFrame_Time)
{
  ...
  SPEEDO_WATERF_4M.draw(AUTOMOBILE_PANEL, Refresh, tmeFrame_Time);
  SPEEDO_WATERF_16M.draw(AUTOMOBILE_PANEL, Refresh, tmeFrame_Time);
  SPEEDO_WATERF_64M.draw(AUTOMOBILE_PANEL, Refresh, tmeFrame_Time);
  SPEEDO_WATERF_256M.draw(AUTOMOBILE_PANEL, Refresh, tmeFrame_Time);
