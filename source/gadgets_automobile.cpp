...
void AUTOMOBILE_GADGET::create()
{
  ...
  SPEEDO_WATERF_A.PROP.POSX = 13 + 0;
  SPEEDO_WATERF_A.PROP.POSY = 6;
  SPEEDO_WATERF_A.PROP.BAR_SIZE = 19;
  SPEEDO_WATERF_A.PROP.MIN_VALUE = 0;
  SPEEDO_WATERF_A.PROP.MAX_VALUE = 100;
  SPEEDO_WATERF_A.PROP.TIME_SPAN = 60000 * 5;
  SPEEDO_WATERF_A.PROP.INDICATOR_CHARACTER = '0';
  SPEEDO_WATERF_A.PROP.BRACKET_END_CAPS = false;
  SPEEDO_WATERF_A.PROP.JECT = true;
  SPEEDO_WATERF_A.PROP.COLOR_MARKER = COLOR_BLUE;
  SPEEDO_WATERF_A.PROP.BCOLOR_MARKER = COLOR_WHITE;
  SPEEDO_WATERF_A.PROP.COLOR_BAR_BACK = COLOR_BLUE;
  SPEEDO_WATERF_A.PROP.COLOR_MARKER_LIMIT = COLOR_YELLOW;
  SPEEDO_WATERF_A.create();

  SPEEDO_WATERF_B.PROP.POSX = 13 + 0;
  SPEEDO_WATERF_B.PROP.POSY = 7;
  SPEEDO_WATERF_B.PROP.BAR_SIZE = 19;
  SPEEDO_WATERF_B.PROP.MIN_VALUE = 0;
  SPEEDO_WATERF_B.PROP.MAX_VALUE = 100;
  SPEEDO_WATERF_B.PROP.TIME_SPAN = 60000 * 15;
  SPEEDO_WATERF_B.PROP.INDICATOR_CHARACTER = '0';
  SPEEDO_WATERF_B.PROP.BRACKET_END_CAPS = false;
  SPEEDO_WATERF_B.PROP.JECT = true;
  SPEEDO_WATERF_B.PROP.COLOR_MARKER = COLOR_BLUE;
  SPEEDO_WATERF_B.PROP.BCOLOR_MARKER = COLOR_WHITE;
  SPEEDO_WATERF_B.PROP.COLOR_BAR_BACK = COLOR_BLUE;
  SPEEDO_WATERF_B.PROP.COLOR_MARKER_LIMIT = COLOR_YELLOW;
  SPEEDO_WATERF_B.create();

  SPEEDO_WATERF_C.PROP.POSX = 13 + 0;
  SPEEDO_WATERF_C.PROP.POSY = 8;
  SPEEDO_WATERF_C.PROP.BAR_SIZE = 19;
  SPEEDO_WATERF_C.PROP.MIN_VALUE = 0;
  SPEEDO_WATERF_C.PROP.MAX_VALUE = 100;
  SPEEDO_WATERF_C.PROP.TIME_SPAN = 60000 * 40;
  SPEEDO_WATERF_C.PROP.INDICATOR_CHARACTER = '0';
  SPEEDO_WATERF_C.PROP.BRACKET_END_CAPS = false;
  SPEEDO_WATERF_C.PROP.JECT = true;
  SPEEDO_WATERF_C.PROP.COLOR_MARKER = COLOR_BLUE;
  SPEEDO_WATERF_C.PROP.BCOLOR_MARKER = COLOR_WHITE;
  SPEEDO_WATERF_C.PROP.COLOR_BAR_BACK = COLOR_BLUE;
  SPEEDO_WATERF_C.PROP.COLOR_MARKER_LIMIT = COLOR_YELLOW;
  SPEEDO_WATERF_C.create();

  SPEEDO_WATERF_D.PROP.POSX = 13 + 0;
  SPEEDO_WATERF_D.PROP.POSY = 9;
  SPEEDO_WATERF_D.PROP.BAR_SIZE = 19;
  SPEEDO_WATERF_D.PROP.MIN_VALUE = 0;
  SPEEDO_WATERF_D.PROP.MAX_VALUE = 100;
  SPEEDO_WATERF_D.PROP.TIME_SPAN = 60000 * 60;
  SPEEDO_WATERF_D.PROP.INDICATOR_CHARACTER = '0';
  SPEEDO_WATERF_D.PROP.BRACKET_END_CAPS = false;
  SPEEDO_WATERF_D.PROP.JECT = true;
  SPEEDO_WATERF_D.PROP.COLOR_MARKER = COLOR_BLUE;
  SPEEDO_WATERF_D.PROP.BCOLOR_MARKER = COLOR_WHITE;
  SPEEDO_WATERF_D.PROP.COLOR_BAR_BACK = COLOR_BLUE;
  SPEEDO_WATERF_D.PROP.COLOR_MARKER_LIMIT = COLOR_YELLOW;
  SPEEDO_WATERF_D.create();

  SPEEDO_WATERF_E.PROP.POSX = 13 + 0;
  SPEEDO_WATERF_E.PROP.POSY = 10;
  SPEEDO_WATERF_E.PROP.BAR_SIZE = 19;
  SPEEDO_WATERF_E.PROP.MIN_VALUE = 0;
  SPEEDO_WATERF_E.PROP.MAX_VALUE = 100;
  SPEEDO_WATERF_E.PROP.TIME_SPAN = 60000 * 60 * 4;
  SPEEDO_WATERF_E.PROP.INDICATOR_CHARACTER = '0';
  SPEEDO_WATERF_E.PROP.BRACKET_END_CAPS = false;
  SPEEDO_WATERF_E.PROP.JECT = true;
  SPEEDO_WATERF_E.PROP.COLOR_MARKER = COLOR_BLUE;
  SPEEDO_WATERF_E.PROP.BCOLOR_MARKER = COLOR_WHITE;
  SPEEDO_WATERF_E.PROP.COLOR_BAR_BACK = COLOR_BLUE;
  SPEEDO_WATERF_E.PROP.COLOR_MARKER_LIMIT = COLOR_YELLOW;
  SPEEDO_WATERF_E.create();
...
{  
  ...
  {
    SPEEDO_WATERF_A.update_via_slice(SPEEDO.jecto(), tmeFrame_Time);
  }

  if (SPEEDO_WATERF_A.jecto_ready() == true)
  {
    SPEEDO_WATERF_B.update_via_slice(SPEEDO_WATERF_A.jecto(), tmeFrame_Time);
  }

  if (SPEEDO_WATERF_B.jecto_ready() == true)
  {
    SPEEDO_WATERF_C.update_via_slice(SPEEDO_WATERF_B.jecto(), tmeFrame_Time);
  }

    if (SPEEDO_WATERF_C.jecto_ready() == true)
  {
    SPEEDO_WATERF_D.update_via_slice(SPEEDO_WATERF_C.jecto(), tmeFrame_Time);
  }

  if (SPEEDO_WATERF_D.jecto_ready() == true)
  {
    SPEEDO_WATERF_E.update_via_slice(SPEEDO_WATERF_D.jecto(), tmeFrame_Time);
  }
  //-----------
...
bool AUTOMOBILE_GADGET::draw(bool Refresh, unsigned long tmeFrame_Time)
{
  ...
  SPEEDO_WATERF_A.draw(AUTOMOBILE_PANEL, Refresh, tmeFrame_Time);
  SPEEDO_WATERF_B.draw(AUTOMOBILE_PANEL, Refresh, tmeFrame_Time);
  SPEEDO_WATERF_C.draw(AUTOMOBILE_PANEL, Refresh, tmeFrame_Time);
  SPEEDO_WATERF_D.draw(AUTOMOBILE_PANEL, Refresh, tmeFrame_Time);
  SPEEDO_WATERF_E.draw(AUTOMOBILE_PANEL, Refresh, tmeFrame_Time);
